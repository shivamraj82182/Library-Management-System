...
export const adminBooksPageStyles = {
  ...
  textInput:
"w-full rounded-2xl border border-library-ink/10 bg-white px-4 py-3 text-library-ink placeholder:text-library-ink/45 outline-none",
  ...
  bookFieldInput:
"w-full rounded-2xl border border-library-ink/10 bg-library-paper/80 px-4 py-3 text-library-ink placeholder:text-library-ink/45 outline-none",
