...
// dummy data so for frontend users or who wants the data for data entry

const defaultFineSettings = {
  amount: 10,
  interval: "day",
};
// dummy data sp for frontend users or who wants the data for data entry
const defaultBooks = [
  {
    id: 1,
    bookCode: "1001",
...
// we have created this in the backend too
  ...
  const fetchManualIssues = async () => {
    ...
    try {
      ...
      const response = await fetch(issuesUrl, {
        headers: getHeaders(),//fair user validation either admin or student
      });
